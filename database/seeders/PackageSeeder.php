    ...
    public function run()
    {
        $packages = [
            ...
            [
                ...
                Then our driver will pick you up to Spice farm Tour. The tour is guided by the local 
                guide of the spice farms who will take you around the history of spices in Zanzibar 
                and where you will see and taste the tropical fruits, spices plantation or plots in the 
                island. A variety of spices plants used as ornament, medicines, flowers, fruits and 
                another interesting flora can be seen during spice tour.',
                // 'Day 3:  MNEMBA ISLAND TOUR',
                'n the morning at 7:30 am the driver will pick you up from the hotel to Mnemba
                ...
                and then a well-prepared seafood BBQ lunch at the beach. After the tour at 2:00 pm 
            ...
            [
                ...
                On the way back you will enjoy a relaxing time on the boat with fresh seasonal fruits 
                and then a well-prepared seafood BBQ lunch at the beach. After the tour at 2:00 pm 
                the driver will take you back to your hote ',
            ...
            [
                ...
                'At 11:00pm the driver will take you to Baraka Natural Aquarium in Nungwi the 
                North of Zanzibar which is a magical little lagoon that rescues and rehabilitates sea 
                turtles that have been accidentally caught in the fisherman`s nets and then 
                eventually releases them back into the wild. Swimming with these sea turtles is 
                definitely one of the cooler experiences you can do on the island. 
                At 04:00 pm you will head to meet the boat captain for Dhow Sunset Cruise, also 
                done in Nungwi beach that involves the use handcrafted dhow that are operated by 
                professional, trained crew and fully equipped with life jackets, first aid kit, sunshade, 
                boarding ladder and waterproof bags. After the sunset the guide will take you back to
                the hotel.',
                // 'Day 3: MNEMBA ISLAND TOUR',
                'In the morning at 7:30 am the driver will pick you up from the hotel to Mnemba
                Island. This is a small island located outside the northeast coast of Zanzibar. The 
            ...
            [
                ...
                jump in and swim, snorkeling with them. Our professional guide will show you coral 
                reef and different type of fish. If the tide is low, we also stop by Mnemba sandbank 
                and you can get off there for a while. On the way back you will enjoy a relaxing time on the boat with fresh seasonal fruits 
                and then a well-prepared seafood BBQ lunch at the beach. After the tour at 2:00 pm 
                the driver will take you back to your hotel',
                // 'Day 4: STONE TOWN + JOZANI FOREST ',
                'At 9:00 am the driver/guide will take you to Stone Town Tour, this tour takes around 
                ...
                After snorkelling you will go to Kwale Island where you will have the buffet barbeque 
                lunch that will include fish, lobster, calamari, rice, and fried potatoes saved with 
                sauces all served hot from grilled, soft drinks such as soda, with beer. When the 
                tides permit you will explore the natural blue lagoon found in the Kwale Island. The 
                lagoon is surrounded by mangrove forest and you will swim in the lagoon for 
                unforgettable memory. As a safari blue come to an end, the driver will take you back 
                to your hotel.',
                // 'Day 7: REST DAY',

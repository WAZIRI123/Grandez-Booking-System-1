    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10">
            ...
            <div class="flex items-center justify-between mt-6">
                ...
                <div class="flex flex-col">
                    <div class="flex items-end">
                        <span class="text-2xl 2xl:text-4xl font-bold">{{ $carreservation->where('status','confirmed')->count() }}</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="px-6 py-6 bg-white rounded-lg shadow-xl">
            ...
            <div class="flex items-center justify-between mt-6">
                ...
                <div class="flex flex-col">
                    <div class="flex items-end">
                        <span class="text-2xl 2xl:text-4xl font-bold">{{ $carreservation->where('status','rejected')->count() }}</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="px-6 py-6 bg-white rounded-lg shadow-xl">
            ...
            <div class="flex items-center justify-between mt-6">
                ...
                <div class="flex flex-col">
                    <div class="flex items-end">
                        <span class="text-2xl 2xl:text-4xl font-bold">{{ $carreservation->where('status','waiting')->count() }}</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="px-6 py-6 bg-white rounded-lg shadow-xl">
            ...
            <div class="flex items-center justify-between mt-6">
                ...
                <div class="flex flex-col">
                    <div class="flex items-end">
                        <span class="text-2xl 2xl:text-4xl font-bold">{{ $carreservation->count() }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <tbody class="text-sm">
                ...
                <tr class="bg-gray-100 hover:bg-primary hover:bg-opacity-20 transition duration-200">
                    ...
                    <td class="py-3 pl-2">
                            ...
                            <div class="flex flex-col">
                                <select name="{{$carreservation->id}}" wire:model="status" wire:change="changeStatus({{$carreservation->id}})" id="{{$carreservation->id}}" class="mt-2 py-1 border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded-lg">

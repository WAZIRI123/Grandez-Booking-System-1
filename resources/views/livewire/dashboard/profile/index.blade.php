            ...
            <form wire:submit.prevent='updateUser'>
                <div class="grid grid-cols-3 gap-8">
                    ...
                    <div class="flex flex-col my-4">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" wire:model="email" class="flex-1 py-1 border-gray-300 mt-1 rounded focus:outline-none focus:ring-0 focus:border-gray-300" placeholder="Your Email Address">

                    </div>

                    <div class="flex flex-col my-4">
                        <label for="address_multiple_columns">Phone</label>
                        <input type="text" name="phone" value="{{ old('phone') }}" wire:model="phone" id="address_multiple_columns" class="flex-1 py-1 border-gray-300 mt-1 rounded focus:outline-none focus:ring-0 focus:border-gray-300" placeholder="Your Address">

        ...
        <aside class="relative  lg:col-span-4 space-y-4 ">
            <div class="space-y-2">
                ...
                <p class="tracking-wide text-gray-600 sm:text-base text-sm">
                    {{ __("Interested in this car? Hurry up and book before it's too late! ") }}<span class="font-bold">{{ __(' trip available.') }}</span>
                </p>
            </div>
            <hr>
            @auth
                ...
                <div class="grid gap-4">
                    <div class="grid lg:grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="form-control">
                            <label for="date" class="label">{{ __('Date') }}</label>
                            <input class="w-full input" type="date" name="date" min="{{$min_date}}" wire:model='date' id="date" />
                            @error('date')

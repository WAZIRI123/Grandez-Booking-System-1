                    ...
                    @else
                        <form action="#" method="POST" wire:submit.prevent='reservation' class="grid gap-4">
                            <div class="grid lg:grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="form-control">
                                    <label for="check_in" class="label">{{ __('Check In') }}</label>
                                    <input class="w-full input" type="date" name="check_in" min=" wire:change="setCheckIn" wire:model='check_in' id="check_in"/>
                                    @error('check_in')
                                ...
                                <div class="form-control">
                                    <label for="check_out" class="label">{{ __('Check Out') }}</label>
                                    <input class="w-full input" type="date" name="check_out" min="" wire:change="setCheckOut" wire:model='check_out' id="check_out"/>
                                    @error('check_out')
                                        <span class="invalid">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-control">
                                <label for="total_packages" class="label">{{ __('Total packages') }}</label>
                                <input class="w-full input" type="number" name="total_packages" min="1"  wire:keyup='setPrice' wire:model="total_packages" id="total_packages"/>
                                @error('total_packages')
                                    <span class="invalid">{{ $message }}</span>
                                @enderror
                            </div>
                            @if ($check_in && $check_out && $total_packages)
                                <p class="tracking-wide text-gray-600 sm:text-base text-sm">Total price to pay for this <span class="font-bold"></span> day stay with <span class="font-bold"></span> packages is <span class="font-bold"></span>. <span class="font-bold">Paid directly at the hotel, not online.</span></p>
                            @endif
